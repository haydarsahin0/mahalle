...
export function createMap(container,boundary,callbacks){
 ...
 map.addSource('turkey',{type:'geojson',data:boundary});map.addLayer({id:'turkey-border',type:'line',source:'turkey',paint:{'line-color':'#ecebd9','line-width':1.5,'line-opacity':.75}});
