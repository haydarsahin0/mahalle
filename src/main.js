...
let user=null,account_={name:'',welcomeGiftClaimed:true,welcomeGiftParcelId:null,stripeOnboardingComplete:false,firstHomeClaimed:true},map,selected=null,tab='explore',filter='all',visible=[],places=[],recent=[],busy=false,available=false,lastBox='',giftPromptedFor=null;
