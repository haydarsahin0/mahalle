...
test('zoning follows real settlement data, not the grid',()=>{
 ...
 // One jeton is one lira: remote farmland sits exactly on the four-kuruş floor, and denser,
 ...
 assert.equal(parcel(parcelId(...FARM)).value,Math.ceil(parcel(parcelId(...FARM)).area*BASE_PRICE));});
